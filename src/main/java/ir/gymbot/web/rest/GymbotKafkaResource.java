...
@RestController
@RequestMapping("/api/gymbot-kafka")
public class GymbotKafkaResource {

    private final Logger log = LoggerFactory.getLogger(GymbotKafkaResource.class);
    ...
    public GymbotKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
